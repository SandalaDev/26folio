---
handoff_type: review
id: HANDOFF-REVIEW-TASK-007
created: 2026-06-30T14:23:48.039Z
created_by: claude-code
task_ref: backlog/done/TASK-007.md
slice_ref: planning/slices/EPIC-002-SLICE-1.md
...
---
# Handoff: Review TASK-007

## Purpose
Cross-model review of TASK-007 ("Colour + base design tokens & global foundation") before human merge.
Reviewer family must differ from `claude-code`.

## Current State
Implementation complete; gate proofs as recorded above. Diff scoped to
`files_allowed` in backlog/done/TASK-007.md.

## Completed
- See backlog/done/TASK-007.md acceptance criteria.
